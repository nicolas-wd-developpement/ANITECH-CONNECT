        ...
        <v-card-text black>
            <v-row>
                ...
                <v-col cols="12" lg="8">
                    ...
                    <p> Please send an email to <a href="mailto:">nicolasblond@web-designers.fr</a></p>
                    <h2> For any other question</h2>
                    <p> Please send an email to <a href="mailto:">ir.sales@outlook.com</a></p>
                </v-col>
                <v-col cols="0" lg="2">
                </v-col>
            </v-row>
        ...
        <v-card-text black>
            ...
            <v-col cols="12" lg="8">
                ...
                <p>The purpose of the ANITECH CONNECT application is to make public the contact details of the owner of an ANITECH CONNECT tag, 
                    to allow them to be contacted and thus find their pet. Import and retail International DAC cannot be held responsible for any misuse by third parties.</p>
